...
<html lang="pt-BR">
	...
	<body>
		...
		<section id="about" class="animated-content js-animated-content">
			...
			<p>Faça o <a href="<?php echo $base_url ?>content/download/curriculo.pdf" target="_blank" onclick="ga('send', 'event', {eventCategory: 'Button', eventAction: 'Curriculum Vitae'});">download do meu currículo</a> para outras informações relevantes sobre mim.</p>
		</section>
