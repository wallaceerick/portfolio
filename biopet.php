	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            ...
		            <img src="<?php echo $base_url ?>content/images/portfolio/biopet/2.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/biopet/3.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/biopet/4.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/biopet/5.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php echo $base_url ?>natura">
					<div class="title">
						<h3>Natura</h3>
					</div>
					<span></span>
