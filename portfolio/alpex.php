	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/alpex/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/alpex/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/alpex/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/alpex/4.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/alpex/5.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/alpex/6.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			...
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/lorpen">
					<div class="title">
						<h3>Lorpen</h3>
					</div>
					<span></span>
