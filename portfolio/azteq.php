	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/azteq/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/azteq/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/azteq/3.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/mondial">
					<div class="title">
						<h3>Mondial <span>Curtindo a Casa</span></h3>
					</div>
					<span></span>
					<img src="<?php base_url(); ?>content/images/portfolio/mondial/preview.jpg" alt="Mondial Curtindo a Casa" />
				</a>
			</div>
