	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/azul-fish/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/azul-fish/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/azul-fish/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/azul-fish/4.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/azul-fish/5.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/azul-fish/6.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/deuter">
					<div class="title">
						<h3>Deuter</h3>
					</div>
					<span></span>
			...
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/chevrolet">
					<div class="title">
						<h3>Chevrolet <span>Aba Motors</span></h3>
					</div>
					<span></span>
					<img src="<?php base_url(); ?>content/images/portfolio/chevrolet/preview.jpg" alt="Chevrolet Aba Motors" />
				</a>
			</div>
		</section>
