	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/cubos/lagos/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/cubos/lagos/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/cubos/lagos/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/cubos/lagos/4.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/cubos/lagos/5.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/cubos/lagos/6.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/colson">
					<div class="title">
						<h3>Colson</h3>
					</div>
					<span></span>
					<img src="<?php base_url(); ?>content/images/portfolio/colson/preview.jpg" alt="Colson" />
				</a>
			</div>
