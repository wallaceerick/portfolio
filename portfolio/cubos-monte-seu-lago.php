...
<html lang="pt-BR">
	...
	<head prefix="og: http://ogp.me/ns#">
		...
		<title>Cubos [Monte Seu Lago] • Wallace Erick | Desenvolvedor Front-End &amp; Designer</title>
	...
	<body>
		...
		<section id="page" class="animated-page-head js-animated-page-head">
			...
			<span class="animated-text js-animated-text">
				<h2>Cubos <span class="type">Monte Seu Lago</span></h2>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="row wrapper">
		    	<span class="column column-third animated-column">
		    		...
		    		<ul>
		    			...
		    			<li><strong>Data:</strong> Dezembro de 2013</li>
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/cubos/monte-seu-lago/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/cubos/monte-seu-lago/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/cubos/monte-seu-lago/3.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/cubos-revestimentos">
					<div class="title">
						<h3>Cubos <span>Revestimentos</span></h3>
					</div>
					<span></span>
					<img src="<?php base_url(); ?>content/images/portfolio/cubos/revestimentos/preview.jpg" alt="Cubos Revestimentos" />
				</a>
			</div>
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/cubos-meu-primeiro-lago">
					<div class="title">
