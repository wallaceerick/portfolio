...
<html lang="pt-BR">
	...
	<head prefix="og: http://ogp.me/ns#">
		...
		<title>Cubos [Revestimentos] • Wallace Erick | Desenvolvedor Front-End &amp; Designer</title>
	...
	<body>
		...
		<section id="page" class="animated-page-head js-animated-page-head">
			...
			<span class="animated-text js-animated-text">
				<h2>Cubos <span class="type">Revestimentos</span></h2>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="row wrapper">
		    	<span class="column column-third animated-column">
		    		...
		    		<ul>
		    			...
		    			<li><strong>Data:</strong> Fevereiro de 2013</li>
		    	...
		    	<span class="column column-third animated-column">
		            ...
		            <a href="http://cubosrevestimentos.com.br/" target="_blank" class="external">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/cubos/revestimentos/1.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/cubos-lagos">
					<div class="title">
			...
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/cubos-monte-seu-lago">
					<div class="title">
