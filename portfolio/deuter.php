...
<html lang="pt-BR">
	...
	<head prefix="og: http://ogp.me/ns#">
		...
		<title>Deuter • Wallace Erick | Desenvolvedor Front-End &amp; Designer</title>
	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="row wrapper">
		    	<span class="column column-third animated-column">
		    		...
		    		<ul>
		    			...
		    			<li><strong>Data:</strong> Outubro de 2010</li>
		    	...
		    	<span class="column column-third animated-column">
		            ...
		            <a href="http://www.deuter.com.br/" target="_blank" class="external">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/deuter/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/deuter/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/deuter/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/deuter/4.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/deuter/5.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/deuter/6.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/azteq">
					<div class="title">
						<h3>Azteq</h3>
					</div>
					<span></span>
			...
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/azul-fish">
					<div class="title">
						<h3>Azul Fish</h3>
					</div>
					<span></span>
