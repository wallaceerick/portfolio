...
<html lang="pt-BR">
	...
	<head prefix="og: http://ogp.me/ns#">
		...
		<title>Digitaliza • Wallace Erick | Desenvolvedor Front-End &amp; Designer</title>
	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="row wrapper">
		    	<span class="column column-third animated-column">
		    		...
		    		<ul>
		    			...
		    			<li><strong>Data:</strong> Agosto de 2013</li>
		    	...
		    	<span class="column column-third animated-column">
		            ...
		            <a href="http://www.digitalizaempresas.com/" target="_blank" class="external">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/digitaliza/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/digitaliza/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/digitaliza/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/digitaliza/4.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/digitaliza/5.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/sarlo">
					<div class="title">
						<h3>Sarlo</h3>
					</div>
					<span></span>
			...
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/alpex">
					<div class="title">
						<h3>Alpex</h3>
					</div>
					<span></span>
