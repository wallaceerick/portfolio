	...
	<body>
		...
		<section id="page" class="animated-page-head js-animated-page-head">
			...
			<span class="page-icon js-animated-icon">
				<i class="icon icon-digitaliza"></i>
			</span>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php echo $base_url ?>content/images/portfolio/digitaliza/1.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/digitaliza/2.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/digitaliza/3.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/digitaliza/4.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/digitaliza/5.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			...
			<div class="project project-right">
				<a href="<?php echo $base_url ?>/portfolio/alpex">
					<div class="title">
						<h3>Alpex</h3>
					</div>
					<span></span>
