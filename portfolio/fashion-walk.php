	...
	<body>
		...
		<section id="page" class="animated-page-head js-animated-page-head">
			...
			<span class="page-icon js-animated-icon">
				<i class="icon icon-fashion-walk"></i>
			</span>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php echo $base_url ?>content/images/portfolio/fashion-walk/1.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/fashion-walk/2.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/fashion-walk/3.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
