	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/gendai/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/gendai/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/gendai/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/gendai/4.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/gendai/5.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/gendai/6.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/gendai/7.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/gendai/8.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/gendai/9.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			...
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/paganelli-shop">
					<div class="title">
