	...
	<body>
		...
		<section id="page" class="animated-page-head js-animated-page-head">
			...
			<span class="page-icon js-animated-icon">
				<i class="icon icon-home-refill"></i>
			</span>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php echo $base_url ?>content/images/portfolio/home-refill/1.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/home-refill/2.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/home-refill/3.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/home-refill/4.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			...
			<div class="project project-right">
				<a href="<?php echo $base_url ?>/portfolio/biopet">
					<div class="title">
						<h3>Biopet</h3>
					</div>
					<span></span>
					<img src="<?php echo $base_url ?>content/images/portfolio/biopet/preview.jpg" alt="Home Refill" />
				</a>
			</div>
		</section>
