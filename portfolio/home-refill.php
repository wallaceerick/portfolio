...
<html lang="pt-BR">
	...
	<head prefix="og: http://ogp.me/ns#">
		...
		<title>Home Refill • Wallace Erick | Desenvolvedor Front-End &amp; Designer</title>
	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="row wrapper">
		    	<span class="column column-third animated-column">
		    		...
		    		<ul>
		    			...
		    			<li><strong>Data:</strong> Agosto de 2014</li>
		    	...
		    	<span class="column column-third animated-column">
		            ...
		            <a href="https://www.homerefill.com.br/" target="_blank" class="external">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/home-refill/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/home-refill/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/home-refill/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/home-refill/4.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			...
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/biopet">
					<div class="title">
						<h3>Biopet</h3>
					</div>
					<span></span>
					<img src="<?php base_url(); ?>content/images/portfolio/biopet/preview.jpg" alt="Home Refill" />
				</a>
			</div>
		</section>
