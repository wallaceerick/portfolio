...
<html lang="pt-BR">
	...
	<head prefix="og: http://ogp.me/ns#">
		...
		<title>Íntegra Medical • Wallace Erick | Desenvolvedor Front-End &amp; Designer</title>
	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="row wrapper">
		    	<span class="column column-third animated-column">
		    		...
		    		<ul>
		    			...
		    			<li><strong>Data:</strong> Agosto de 2012</li>
		    	...
		    	<span class="column column-third animated-column">
		            ...
		            <a href="http://www.integramedical.com.br/" target="_blank" class="external">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/integra-medical/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/integra-medical/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/integra-medical/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/integra-medical/4.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/integra-medical/5.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/positivo-english-solution">
					<div class="title">
						<h3>Positivo</h3>
					</div>
					<span></span>
			...
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/smartia">
					<div class="title">
						<h3>Smartia</h3>
					</div>
					<span></span>
					<img src="<?php base_url(); ?>content/images/portfolio/smartia/preview.jpg" alt="Íntegra Medical" />
				</a>
			</div>
		</section>
