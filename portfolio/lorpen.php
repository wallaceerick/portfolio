		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php echo $base_url ?>content/images/portfolio/lorpen/1.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/lorpen/2.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/lorpen/3.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/lorpen/4.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
