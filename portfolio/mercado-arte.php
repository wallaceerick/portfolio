	...
	<body>
		...
		<section id="page" class="animated-page-head js-animated-page-head">
			...
			<span class="page-icon js-animated-icon">
				<i class="icon icon-mercado-arte"></i>
			</span>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php echo $base_url ?>content/images/portfolio/mercado-arte/1.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/mercado-arte/2.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/mercado-arte/3.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/mercado-arte/4.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/mercado-arte/5.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/mercado-arte/6.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
