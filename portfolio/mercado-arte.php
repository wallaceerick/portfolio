...
<html lang="pt-BR">
	...
	<head prefix="og: http://ogp.me/ns#">
		...
		<title>Mercado Arte • Wallace Erick | Desenvolvedor Front-End &amp; Designer</title>
	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="row wrapper">
		    	...
		    	<span class="column column-third animated-column">
		    		...
		    		<p>O desenvolvimento da interface do projeto, layout, recursos em javascript e integração com Back-End feito em PHP no CodeIgniter.</p>
		            <a href="https://www.mercadoarte.com.br/" target="_blank" class="external">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/mercado-arte/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/mercado-arte/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/mercado-arte/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/mercado-arte/4.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/mercado-arte/5.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/mercado-arte/6.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/galvao">
					<div class="title">
						<h3>Galvão</h3>
					</div>
					<span></span>
					<img src="<?php base_url(); ?>content/images/portfolio/galvao/preview.jpg" alt="Galvão" />
				</a>
			</div>
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/oi">
					<div class="title">
						<h3>Oi</h3>
					</div>
					<span></span>
