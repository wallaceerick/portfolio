	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/natura/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/natura/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/natura/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/natura/4.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/natura/5.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/natura/6.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/navegatium">
					<div class="title">
						<h3>Navegatium</h3>
					</div>
					<span></span>
