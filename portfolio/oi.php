	...
	<body>
		...
		<section id="page" class="animated-page-head js-animated-page-head">
			...
			<span class="animated-text js-animated-text">
				<h2>Oi <span class="type">Vida Saudável</span></h2>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="row wrapper">
		    	...
		    	<span class="column column-third animated-column">
		    		...
		    		<p>O desenvolvimento da interface do projeto, recursos em javascript e banner animado no Flash.</p>
		            <a href="http://imaginera.com.br/clientes/oi/" target="_blank" class="external">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/oi/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/oi/2.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/mercado-arte">
					<div class="title">
						<h3>Mercado Arte</h3>
					</div>
					<span></span>
