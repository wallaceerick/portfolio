...
<html lang="pt-BR">
	...
	<head prefix="og: http://ogp.me/ns#">
		...
		<title>Grupo Onda • Wallace Erick | Desenvolvedor Front-End &amp; Designer</title>
	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="row wrapper">
		    	<span class="column column-third animated-column">
		    		...
		    		<ul>
		    			...
		    			<li><strong>Data:</strong> Fevereiro de 2014</li>
		    	...
		    	<span class="column column-third animated-column">
		    		...
		    		<p>O desenvolvimento da interface do projeto, recursos em javascript e integração com o Wordpress.</p>
		            <a href="http://www.ondaaquarios.com.br/" target="_blank" class="external">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/onda/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/onda/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/onda/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/onda/4.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/onda/5.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/fashion-walk">
					<div class="title">
						<h3>Fashion Walk</h3>
					</div>
					<span></span>
			...
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/toyota">
					<div class="title">
						<h3>Toyota</h3>
					</div>
					<span></span>
					<img src="<?php base_url(); ?>content/images/portfolio/toyota/preview.jpg" alt="Toyota" />
				</a>
			</div>
		</section>
