	...
	<body>
		...
		<section id="page" class="animated-page-head js-animated-page-head">
			...
			<span class="page-icon js-animated-icon">
				<i class="icon icon-paganelli-shop"></i>
			</span>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php echo $base_url ?>content/images/portfolio/paganelli-shop/1.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/paganelli-shop/2.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/paganelli-shop/3.jpg" alt="" />
		            <img src="<?php echo $base_url ?>content/images/portfolio/paganelli-shop/4.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
