...
<html lang="pt-BR">
	...
	<head prefix="og: http://ogp.me/ns#">
		...
		<title>Paganelli Shop • Wallace Erick | Desenvolvedor Front-End &amp; Designer</title>
	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="row wrapper">
		    	<span class="column column-third animated-column">
		    		...
		    		<ul>
		    			...
		    			<li><strong>Data:</strong> Janeiro de 2014</li>
		    	...
		    	<span class="column column-third animated-column">
		    		...
		    		<p>O desenvolvimento da interface do projeto, recursos em javascript e integração com o Magento.</p>
		            <a href="http://www.dizamem.com.br/" target="_blank" class="external">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/paganelli-shop/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/paganelli-shop/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/paganelli-shop/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/paganelli-shop/4.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/gendai">
					<div class="title">
						<h3>Gendai</h3>
					</div>
					<span></span>
			...
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/home-refill">
					<div class="title">
						<h3>Home Refill</h3>
					</div>
					<span></span>
