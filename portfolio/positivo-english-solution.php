	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/positivo/english-solution/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/positivo/english-solution/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/positivo/english-solution/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/positivo/english-solution/4.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/positivo/english-solution/5.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/positivo/english-solution/6.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/tam">
					<div class="title">
						<h3>Tam</h3>
					</div>
					<span></span>
			...
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/integra-medical">
					<div class="title">
