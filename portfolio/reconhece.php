...
<html lang="pt-BR">
	...
	<head prefix="og: http://ogp.me/ns#">
		...
		<title>Reconhece • Wallace Erick | Desenvolvedor Front-End &amp; Designer</title>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="row wrapper">
		    	<span class="column column-third animated-column">
		    		...
		    		<ul>
		    			...
		    			<li><strong>Duração:</strong> 1 Semanas</li>
		    	...
		    	<span class="column column-third animated-column">
		            ...
		            <a href="http://wallaceerick.com.br/clientes/reconhece/" target="_blank" class="external">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/reconhece/1.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
