	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/sadia/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/sadia/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/sadia/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/sadia/4.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/sadia/5.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/sadia/6.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/7ball">
					<div class="title">
						<h3>7ball</h3>
					</div>
					<span></span>
