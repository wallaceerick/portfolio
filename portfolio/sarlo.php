	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/sarlo/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/sarlo/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/sarlo/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/sarlo/4.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/sarlo/5.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/sarlo/6.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/sarlo/7.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/positivo-nuvem">
					<div class="title">
						<h3>Positivo <span>Nuvem</span></h3>
					</div>
					<span></span>
					<img src="<?php base_url(); ?>content/images/portfolio/positivo/nuvem/preview.jpg" alt="Positivo Nuvem" />
				</a>
			</div>
			<div class="project project-right">
				<a href="<?php base_url(); ?>/portfolio/digitaliza">
					<div class="title">
						<h3>Digitaliza</h3>
					</div>
					<span></span>
