	...
	<body>
		...
		<article class="project-details animated-content js-animated-content">
		    ...
		    <div class="projects-carousel">
		        ...
		        <div class="owl-carousel js-projects-carousel">
		            <img src="<?php base_url(); ?>content/images/portfolio/tam/1.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/tam/2.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/tam/3.jpg" alt="" />
		            <img src="<?php base_url(); ?>content/images/portfolio/tam/4.jpg" alt="" />
		        </div> <!-- /owl-carousel -->
		    </div>
		...
		<section class="quick-projects animated-content js-animated-content">
			<div class="project project-left">
				<a href="<?php base_url(); ?>/portfolio/reconhece">
					<div class="title">
						<h3>Reconhece</h3>
					</div>
					<span></span>
